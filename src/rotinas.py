...
# Teste Tráfego DC
def trafegoDC(driver, cfgIndex, cfg, logDir):
    if driver == 'host':
        TrafegoDC.rodar_host(cfg[0], cfg[1], cfg[2], cfg[3], logDir)
    elif driver == 'bridge':
        TrafegoDC.rodar_bridge(cfg[0], cfg[1], cfg[2], cfg[3], logDir)
    elif driver == 'macvlan':
        TrafegoDC.rodar_macvlan(cfg[0], cfg[1], cfg[2], cfg[3], logDir)
    elif driver == 'overlay':
        TrafegoDC.rodar_overlay(cfg[0], cfg[1], cfg[2], cfg[3], logDir)
